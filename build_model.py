...
X_train, X_test, y_train, y_test = train_test_split(
    new_df.drop([187], axis=1), new_df[187], test_size=0.1)
...
model.add(Conv1D(filters=128, kernel_size=(
...
history = model.fit(X_train, y_train, validation_data=(
    X_test, y_test), epochs=50, callbacks=callbacks, batch_size=32)
model.load_weights('best_model.h5')

model.save("ecg_hearbeat_cnn_model.h5")
